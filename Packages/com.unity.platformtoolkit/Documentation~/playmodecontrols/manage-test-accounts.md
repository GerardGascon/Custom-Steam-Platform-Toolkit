...
![Example of a test account inside Play Mode Controls Settings.](../images/test-account-example.png)
...
You can set and modify the following data for each account:
...
For more information, refer to [Play Mode Controls Settings reference](play-mode-controls-settings-reference.md).
